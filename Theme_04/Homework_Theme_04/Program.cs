...
namespace Homework_Theme_04
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[,] matrix = new int[12, 4]; // Задание двумерного массива, в котором 12 строк и 4 столбца Задание одномерного массива для записи прибыли
            ...
            Array.Sort(profit); //Встроенный метод упорядочивани  прибыли
